...
CURRENTFOLDER?=.
GLUESRC=$(CURRENTFOLDER)/android_native_app_glue.c
SRC?=test.c
...
CFLAGS+= -I$(CURRENTFOLDER)/rawdraw -I$(NDK)/sysroot/usr/include -I$(NDK)/sysroot/usr/include/android -I$(NDK)/toolchains/llvm/prebuilt/$(OS_NAME)/sysroot/usr/include/android -fPIC -I$(CURRENTFOLDER) -DANDROIDVERSION=$(ANDROIDVERSION)
